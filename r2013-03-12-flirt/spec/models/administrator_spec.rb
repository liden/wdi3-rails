...
describe Administrator do
  describe '.new' do
    it 'creates an instance of a Administrator' do
...
describe '.create' do
  ...
  describe '#metadata' do
    it 'has administator properties' do
      administrator = Administrator.create(role: 'db', ssn: '111-222-3333', tel: '1-111-222-3333')
      expect(administrator.id).to_not be nil
      expect(administrator.role).to eq 'db'
      expect(administrator.ssn).to eq '111-222-3333'
